...
\begin{figure}[H]
  \centering
  \fbox{\includegraphics[width=0.65\linewidth]{images/comparison_1_paint_bucket_001.png}}
  \caption{画质风格示例}
...
\begin{figure}[H]
  ...
  \begin{subfigure}[b]{0.48\linewidth}
    \fbox{\includegraphics[width=\linewidth]{images/comparison_1_fluorescent_tube_001.png}}
    \caption{CLAHE增强前/后（左=原图，右=处理后）}
  \end{subfigure}
  \hfill
  \begin{subfigure}[b]{0.48\linewidth}
    \fbox{\includegraphics[width=\linewidth]{images/comparison_1_cfl_bulb_001.png}}
    \caption{灯泡类别对比图}
  \end{subfigure}
  \caption{CLAHE实验效果}
...
\begin{figure}[H]
  \centering
  \fbox{\includegraphics[width=0.65\linewidth]{images/comparison_1_pesticide_bottle_001.png}}
...
\begin{figure}[H]
  ...
  \begin{subfigure}[b]{0.31\linewidth}
    \includegraphics[width=\linewidth]{images/comparison_1_batteries_001.png}
    \caption{电池 (Batteries)}
  \end{subfigure}
  \hfill
  \begin{subfigure}[b]{0.31\linewidth}
    \includegraphics[width=\linewidth]{images/comparison_1_nail_polish_001.png}
    \caption{指甲油 (Nail Polish)}
  \end{subfigure}
  \hfill
  \begin{subfigure}[b]{0.31\linewidth}
    \includegraphics[width=\linewidth]{images/comparison_1_medicine_001.png}
    \caption{药品 (Medicine)}
  \end{subfigure}
  ...
  \begin{subfigure}[b]{0.31\linewidth}
    \includegraphics[width=\linewidth]{images/comparison_1_thermometer_001.png}
    \caption{温度计 (Thermometer)}
  \end{subfigure}
  \hfill
  \begin{subfigure}[b]{0.31\linewidth}
    \includegraphics[width=\linewidth]{images/comparison_1_blood_pressure_cuff_001.png}
    \caption{血压计 (Blood Pressure Cuff)}
  \end{subfigure}
  \hfill
  \begin{subfigure}[b]{0.31\linewidth}
    \includegraphics[width=\linewidth]{images/comparison_1_IMG20260504140049.jpg}
